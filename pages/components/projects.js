...
function MyProject(props, projectRef) {
    ...
    return (
        <section className="min-h-screen mx-auto mb-5 justify-center scroll-smooth" ref={projectRef}>
            ...
            <div className="flex md:grid md:grid-cols-1 md:min-h-screen ">
                ...
                <div ref={contentRef} className="md:flex h-auto md:w-9/12 pb-5 md:gap-5 mx-auto lg:gap-10 overflow-x-scroll snap-x snap-mandatory no-scrollbar ">
                    ...
                    <div className="border-t md:ml-10 lg:ml-60 border-gray-200 text-center min-w-fit md:h-auto shadow-lg p-10 rounded-xl mx-auto my-auto snap-center snap-always dark:border-white dark:shadow-gray-500 hover:shadow-neutral-200 dark:hover:shadow-gray-400">
                    ...
                    <div className="ml-3 border-t border-gray-200 text-center min-w-fit md:h-auto shadow-lg p-10 rounded-xl mx-auto my-auto snap-center snap-always dark:border-white dark:shadow-gray-500 hover:shadow-neutral-200 dark:hover:shadow-gray-400">
                        ...
                        <button className="mt-3 rounded-lg border border-gray-800 p-1 text-sm text-blue-700 font-burtons bg-gradient-to-r from-blue-400 via-white to-sky-500 hover:from-sky-500 hover:via-white hover:to-blue-400 
                    ...
                    <div className="border-t md:mr-10 lg:mr-60 border-gray-200 text-center min-w-fit md:h-auto shadow-lg p-10 rounded-xl mx-auto my-auto snap-center snap-always dark:border-white dark:shadow-gray-500 hover:shadow-neutral-200 dark:hover:shadow-gray-400">
                        ...
                        <button className="mt-3 rounded-lg border border-gray-800 p-1 text-sm text-blue-700 font-burtons bg-gradient-to-r 
