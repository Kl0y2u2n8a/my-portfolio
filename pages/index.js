        ...
        <main className="px-10 md:px-20 lg:px-40">
          <section className="min-h-screen">
            ...
            <div className="text-center p-10">
              ...
              <p className="text-md font-rony9 py-3 leading-8 bg-gradient-to-br from-sky-400  to-indigo-700 bg-clip-text text-transparent md:text-lg lg:text-xl lg:py-3">Currently working as Onsite Help desk Service and Dispatch troubleshooting Engineer.
            ...
            <div className="relative mx-auto bg-gradient-to-b from-slate-600 to-neutral-300 rounded-full w-80 h-80 mt-20 overflow-hidden">
          ...
          <section className="min-h-screen p-10">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl w-80 mx-auto">
              
                <h3 className="text-2xl font-salma">CRUD Project</h3>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl w-80 mx-auto">
                ...
                <h3 className="text-2xl font-salma">PHP Login System Project</h3>
                <p className="py-2 font-rony9">description...123</p>
                <h4 className="py-2 text-sky-400 font-rony9">Tools & Language I use</h4>
                <p className="text-red-400 py-1 font-rony9">Visual Studio Code</p>
                <p className="text-red-400 py-1 font-rony9">PHP</p>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl w-80 mx-auto">
                ...
                <h3 className="text-2xl font-salma">TV screen Mini Project</h3>
                <p className="py-2 font-rony9">description...123</p>
                <h4 className="py-2 text-sky-400 font-rony9">Tools & Language I use</h4>
                <p className="text-red-400 py-1 font-rony9">Visual Studio Code</p>
                <p className="text-red-400 py-1 font-rony9">HTML/CSS</p>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl w-80 mx-auto">
              ...
              <h3 className="text-2xl font-salma">Guess a Password Game</h3>
              <p className="py-2 font-rony9">description...123</p>
              <h4 className="py-2 text-sky-400 font-rony9">Tools & Language I use</h4>
              <p className="text-red-400 py-1 font-rony9">Visual Studio Code</p>
              <p className="text-red-400 py-1 font-rony9">HTML/CSS</p>
